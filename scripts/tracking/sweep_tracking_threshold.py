...
def main():
    ...
    parser.add_argument("--config", default="configs/trackers/ab3dmot/centerpoint.yaml")
    ...
    grae_config = yaml.safe_load((root / "configs/trackers/grae/centerpoint.yaml").read_text(encoding="utf-8"))
    ...
    threshold_path = root / "configs/experiments/centerpoint_score_thresholds.yaml"
